...
public class GameSocketEndpoint {
    ...
    /**
     * Callback hook for Message Events. This method will be invoked when the server sends informations to the client.
     *
    ...
    /**
     * Shortcut to send a message to the server containing only an action value and a Json object.
     */
    ...
    /**
     * Send a message to the server. This message is in string form and will not be wrapped in a JSON container.
     *
     * @param message
     */
