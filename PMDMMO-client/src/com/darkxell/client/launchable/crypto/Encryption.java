...
public class Encryption {
    ...
    /**
     * Do NOT call this method unless you want to scare the hell out of your user's ass. <br/>
     * Or perhaps, you know, if a major security breach is discovered in SHA-256, and the user was under attack while
     * java runtime environnement libraries used in this project are not updated.<br/>
     * This method will display a breach error message and instructions in english, and will terminate the application.
     */
    ...
    /**
     * Encrypts an array of bytes into another array of bytes ciphered with the parsed public key.
     */
    ...
    /**
     * Converts a byte array into a hexadecimal string for easy and encoding free transport.
     */
    ...
    /**
     * Encrypts a string using the AES key in the safe and generates a JsonString containing the encrypted data, ready
    ...
    /**
     * Decrypts an encrypted json payload using the AES key in the safe. The result is usually a json payload.
     */
