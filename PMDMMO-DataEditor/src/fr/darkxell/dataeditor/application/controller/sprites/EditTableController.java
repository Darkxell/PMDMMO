...
public class EditTableController implements Initializable {
    ...
    public HashMap<Pair<PokemonSpriteState, Direction>, Integer> generateTable() {
        ...
        for (SpriteTableItem i : this.table.getItems()) {
            if (i.north != -1)
                states.put(new Pair<>(i.state, Direction.NORTH), i.north);
            if (i.northeast != -1)
                states.put(new Pair<>(i.state, Direction.NORTHEAST), i.northeast);
            if (i.east != -1)
                states.put(new Pair<>(i.state, Direction.EAST), i.east);
            if (i.southeast != -1)
                states.put(new Pair<>(i.state, Direction.SOUTHEAST), i.southeast);
            if (i.south != -1)
                states.put(new Pair<>(i.state, Direction.SOUTH), i.south);
            if (i.southwest != -1)
                states.put(new Pair<>(i.state, Direction.SOUTHWEST), i.southwest);
            if (i.west != -1)
                states.put(new Pair<>(i.state, Direction.WEST), i.west);
            if (i.northwest != -1)
                states.put(new Pair<>(i.state, Direction.NORTHWEST), i.northwest);
        }
        return states;
    }
    ...
    public void onEastEdited(CellEditEvent<SpriteTableItem, String> cell) {
        ...
        if (value.matches("\\d+"))
            cell.getRowValue().east = Integer.parseInt(value);
        else {
    ...
    public void onNortheastEdited(CellEditEvent<SpriteTableItem, String> cell) {
        String value = cell.getNewValue();
        if (value.matches("\\d+"))
            cell.getRowValue().northeast = Integer.parseInt(value);
        else {
    ...
    public void onNorthEdited(CellEditEvent<SpriteTableItem, String> cell) {
        String value = cell.getNewValue();
        if (value.matches("\\d+"))
            cell.getRowValue().north = Integer.parseInt(value);
        else {
    ...
    public void onNorthwestEdited(CellEditEvent<SpriteTableItem, String> cell) {
        String value = cell.getNewValue();
        if (value.matches("\\d+"))
            cell.getRowValue().northwest = Integer.parseInt(value);
        else {
    ...
    public void onSoutheastEdited(CellEditEvent<SpriteTableItem, String> cell) {
        String value = cell.getNewValue();
        if (value.matches("\\d+"))
            cell.getRowValue().southeast = Integer.parseInt(value);
        else {
    ...
    public void onSouthEdited(CellEditEvent<SpriteTableItem, String> cell) {
        String value = cell.getNewValue();
        if (value.matches("\\d+"))
            cell.getRowValue().south = Integer.parseInt(value);
        else {
    ...
    public void onSouthwestEdited(CellEditEvent<SpriteTableItem, String> cell) {
        String value = cell.getNewValue();
        if (value.matches("\\d+"))
            cell.getRowValue().southwest = Integer.parseInt(value);
        else {
    ...
    public void onWestEdited(CellEditEvent<SpriteTableItem, String> cell) {
        String value = cell.getNewValue();
        if (value.matches("\\d+"))
            cell.getRowValue().west = Integer.parseInt(value);
        else {
