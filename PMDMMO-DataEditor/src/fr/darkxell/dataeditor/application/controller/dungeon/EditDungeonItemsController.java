...
public class EditDungeonItemsController implements Initializable
{
	...
	{
		DungeonItemTableItem i = new DungeonItemTableItem(new DungeonItemGroup(new FloorSet(1, EditDungeonDataController.instance.currentFloorCount()), 1,
	...
	public void setupFor(Dungeon dungeon)
	{
		...
		if (this.itemType == BURIED) w = dungeon.buriedItemsData();
		else if (this.itemType == SHOP) w = dungeon.shopItemsData();
		else w = dungeon.itemsData();
