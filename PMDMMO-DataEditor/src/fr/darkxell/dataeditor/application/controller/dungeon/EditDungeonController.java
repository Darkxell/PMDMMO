...
public class EditDungeonController implements Initializable {
    ...
    public Dungeon generateDungeon() throws DungeonCreationException {
        return this.dungeonDataTabController.generateDungeon(this.dungeonPokemonTabController.generate(),
                this.dungeonItemsTabController.generate(), this.dungeonShopItemsTabController.generate(),
                this.dungeonBuriedItemsTabController.generate(), this.dungeonTrapsTabController.generate(),
