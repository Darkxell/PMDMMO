...
public class EditDungeonWeatherController implements Initializable
{
	...
	{
		WeatherTableItem i = new WeatherTableItem(Weather.CLEAR.id, new FloorSet(1, EditDungeonDataController.instance.currentFloorCount()));
	...
	{
		if (this.editWeatherController.editing == null || item == null) return;
