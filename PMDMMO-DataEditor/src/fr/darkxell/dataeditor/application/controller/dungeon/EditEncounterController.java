...
public class EditEncounterController implements Initializable {
    ...
    private DungeonEncounterModel generate() throws DungeonCreationException {
        ...
        return new DungeonEncounterModel(this.pokemonCombobox.getValue().getID(),
                Integer.parseInt(this.levelTextfield.getText()), Integer.parseInt(this.weightTextfield.getText()),
                this.aiCombobox.getValue(), this.floorsetController.generate());
    }
    ...
    public void setupFor(DungeonEncounterTableItem encounter) {
        ...
        if (encounter != null) {
            ...
            this.floorsetController.setupFor(null);
    }
