...
public class EditMoveController implements Initializable
{
	...
	private Move generate()
	{
		...
		if (this.ppTextfield.getText().matches("\\d+")) pp = Integer.parseInt(this.ppTextfield.getText());
		else
		{
		...
		if (this.powerTextfield.getText().matches("\\d+")) power = Integer.parseInt(this.powerTextfield.getText());
		else
		{
		...
		if (this.accuracyTextfield.getText().matches("\\d+")) accuracy = Integer.parseInt(this.accuracyTextfield.getText());
		else
		{
		...
		if (this.criticalTextfield.getText().matches("\\d+")) critical = Integer.parseInt(this.criticalTextfield.getText());
		else
		{
	...
	public void onSaveMove()
	{
		...
		if (move != null) MovesTabController.instance.onEdited(move);
	}
