...
public class MoveEventController extends EventController
{
	...
	{
		double xpos = this.xposTextfield.getText().equals("") ? MoveCutsceneEvent.UNSPECIFIED : Double.valueOf(this.xposTextfield.getText());
		double ypos = this.yposTextfield.getText().equals("") ? MoveCutsceneEvent.UNSPECIFIED : Double.valueOf(this.yposTextfield.getText());
