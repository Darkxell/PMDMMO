...
@Stateless
@LocalBean
public class Playerstorage_DAO {
    ...
    public void create(long playerid, long inventoryid) {
        try {
            ...
            PreparedStatement prepare
                    = cn.prepareStatement(
                            "INSERT INTO playerstorage_ (playerid, inventoryid) VALUES (?, ?)"
                    );
    ...
    public void delete(long playerid, long inventoryid) {
        try {
            ...
            cn.createStatement(
                    ...
                    "DELETE FROM playerstorage_ WHERE playerid = " + playerid + " AND inventoryid = " + inventoryid
            );
            cn.close();
        ...
        try {
            ...
            ResultSet result = cn
                    .createStatement(
                            ...
                            "SELECT * FROM playerstorage_ WHERE playerid = " + playerid
                    );
            if (result.first()) {
        ...
        try {
            ...
            ResultSet result = cn
                    .createStatement(
                            ...
                            "SELECT * FROM playerstorage_ WHERE inventoryid = " + inventoryid
                    );
            if (result.first()) {
