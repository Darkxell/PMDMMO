...
import static com.darkxell.client.launchable.ClientSettings.Setting.KEY_ATTACK;
import static com.darkxell.client.launchable.ClientSettings.Setting.KEY_DIAGONAL;
import static com.darkxell.client.launchable.ClientSettings.Setting.KEY_DOWN;
import static com.darkxell.client.launchable.ClientSettings.Setting.KEY_INVENTORY;
import static com.darkxell.client.launchable.ClientSettings.Setting.KEY_ITEM_1;
import static com.darkxell.client.launchable.ClientSettings.Setting.KEY_ITEM_2;
import static com.darkxell.client.launchable.ClientSettings.Setting.KEY_LEFT;
import static com.darkxell.client.launchable.ClientSettings.Setting.KEY_MAP_DOWN;
import static com.darkxell.client.launchable.ClientSettings.Setting.KEY_MAP_LEFT;
import static com.darkxell.client.launchable.ClientSettings.Setting.KEY_MAP_RESET;
import static com.darkxell.client.launchable.ClientSettings.Setting.KEY_MAP_RIGHT;
import static com.darkxell.client.launchable.ClientSettings.Setting.KEY_MAP_UP;
import static com.darkxell.client.launchable.ClientSettings.Setting.KEY_MENU;
import static com.darkxell.client.launchable.ClientSettings.Setting.KEY_MOVE_1;
import static com.darkxell.client.launchable.ClientSettings.Setting.KEY_MOVE_2;
import static com.darkxell.client.launchable.ClientSettings.Setting.KEY_MOVE_3;
import static com.darkxell.client.launchable.ClientSettings.Setting.KEY_MOVE_4;
import static com.darkxell.client.launchable.ClientSettings.Setting.KEY_PAGE_LEFT;
import static com.darkxell.client.launchable.ClientSettings.Setting.KEY_PAGE_RIGHT;
import static com.darkxell.client.launchable.ClientSettings.Setting.KEY_PARTY;
import static com.darkxell.client.launchable.ClientSettings.Setting.KEY_RIGHT;
import static com.darkxell.client.launchable.ClientSettings.Setting.KEY_ROTATE;
import static com.darkxell.client.launchable.ClientSettings.Setting.KEY_RUN;
import static com.darkxell.client.launchable.ClientSettings.Setting.KEY_UP;
...
public class Keys implements KeyListener {
    ...
    /**
     * @return If a run event should take place. private static boolean runDirection(Key[] targetKeys) { for (Key key :
     *         targetKeys) { if (!key.wasPressed) { return true; } } return false; }
     */
     ...
     *
     * @param e        Key event from a {@link #keyPressed(KeyEvent) press} or {@link #keyReleased(KeyEvent) release}
     *                 event.
