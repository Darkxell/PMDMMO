...
public class Res {
	...
	/**
	 * Gets a part of a buffered Image. This method is safe: if the dimensions
	 * specified are out of the image's bound, this will throw no exception but
	 ...
	 *            coordinates are its top left corner.
	 * @param spritesAmmount
	 *            the amount of sprites in the array. Also the length of the
	 *            array, obviously.
	 */
	...
	/**
	 * Gets the mystery dungeon font. if it can't get it, will return a default
	 * font, most likely Arial. The returned font is PLAIN and has a point size
	 * of 1.
	 */
