...
public class Song {
     ...
     * <strong>Deprecated :</strong> this method has been deprecated due to high and not necessary CPU usage. MP3 length
     * can now be obtained by creating a Song Object with the filepath, and using the public Song.length attribute.
     */
    @Deprecated
