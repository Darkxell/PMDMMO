...
public class Song {
	...
	/** Returns the displayname of the song. Usually Artist - Name , but just the name of the mp3 file if not specified. */
	public String getdipsplayname() {
		return this.displayname;
	}

	/** Returns the duration of an mp3 file in miliseconds. Don't work with .wav files. Returns 0 in case of errors.<br/>
	 * Note : I'm aware that this is not hte best method to get it, but I just couldn't find something better. <br/>
	 * <strong>Deprecated :</strong> this method has been deprecated due to high and not necessary CPU usage. MP3 length can now be obtained by creating a Song Object with the filepath, and using the public Song.length attribute. */
	@Deprecated
