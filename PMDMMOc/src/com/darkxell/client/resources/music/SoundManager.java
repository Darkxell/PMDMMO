...
public class SoundManager implements Runnable {
	...
	/** Creates a <code>SoundManager</code>. This constructor creates the needed thread to play the BGM, and is ready to use. */
	public SoundManager() {
	...
	public void setBackgroundMusic(Song song) {
		...
		else forceBackgroundMusic(song);
	}

	/** Does the same as setBackgroundMusic(), but ignores the "already playing this music" check. This is used to replay the same song in loops. */
		...
		Thread t = new Thread(new Runnable() {
			...
			public void run() {
				try {
					...
					if (s == null) Logger.e("Sound couldn't be played.");
					else new Player(s).play();
				} catch (Exception e) {
