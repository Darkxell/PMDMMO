	...
	public static void trigger(int storyposition, boolean fromOpeningState)
	{
		...
		switch (storyposition)
		{
			...
			case 1:
				...
				if (fromOpeningState) CutsceneManager.playCutscene("startingwoods/introduction", true);
			...
			case 45:
				...
				break;
			case 50:
				// TODO:Defeated sulfura. Is in front of the frosty forest and snow path.
				break;
			case 51:
			...
			case 53:
				...
				break;
			case 100:
				// TODO:You cleared magma cavern up to the checkpoint. Loading this storyposition will put you in the magma cavern checkpoint.
				break;
			case 115:
				// TODO:Finished the first part of skytower. Is at the sky tower checkpoint.
				break;
