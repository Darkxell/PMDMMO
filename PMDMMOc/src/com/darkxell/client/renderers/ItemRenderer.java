...
public class ItemRenderer
{
	...
	{
		if (event.item.id == Item.ESCAPE_ORB) return new StaticAnimation(listener, AnimationSpriteset.getSpriteset("resources/items/escape_orb.png", 64, 120),
				new Point(event.user.tile.x * FloorDungeonTileset.TILE_SIZE - 64 / 4, event.user.tile.y * FloorDungeonTileset.TILE_SIZE - 90), 10);
