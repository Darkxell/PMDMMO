...
public class ChatBox {
    ...
    /**
     * Creates a new chatBox instance. Note that this instance will create it's own thread when created.
     */
    public ChatBox() {
    ...
    public void send() {
        ...
        if (Persistence.socketendpoint != null
            ...
            JsonObject mess = new JsonObject().add("action", "chatmessage").add("tag", "alpha")
                    .add("sender", ClientSettings.getSetting(Setting.LOGIN)).add("message", this.lastsent)
                    .add("tagcolor", "#1CFF00").add("messagecolor", Palette.getHexaFromClor(Color.WHITE))
