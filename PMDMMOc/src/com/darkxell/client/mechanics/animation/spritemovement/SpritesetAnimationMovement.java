...
public abstract class SpritesetAnimationMovement
{
	...
	{
		this.parentAnimation.gravityX = this.parentAnimation.spriteset.spriteWidth / 2 - x;
		this.parentAnimation.gravityY = this.parentAnimation.spriteset.spriteHeight / 2 - y;
	}
