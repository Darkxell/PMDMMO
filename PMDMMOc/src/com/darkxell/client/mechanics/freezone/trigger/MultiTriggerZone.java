 ...
 *
 * <p>
 * Child trigger zones will inherit their hitbox from the parent trigger zone. Therefore, if all trigger zones have
 * different hitboxes, you can simply leave those attributes off on the parent.
 * </p>
 */
