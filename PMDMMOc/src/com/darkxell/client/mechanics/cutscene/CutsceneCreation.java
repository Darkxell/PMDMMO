...
public class CutsceneCreation {
    ...
    public CutsceneCreation(FreezoneInfo freezone, boolean fading, boolean drawMap, double camerax, double cameray,
            ArrayList<CutsceneEntity> entities) {
    ...
    public void create() {
        ...
        if (this.camerax != -1)
            Persistence.freezoneCamera.setX(this.camerax);
        if (this.cameray != -1)
            Persistence.freezoneCamera.setY(this.cameray);
