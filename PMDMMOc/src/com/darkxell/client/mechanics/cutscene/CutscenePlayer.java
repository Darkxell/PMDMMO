...
public class CutscenePlayer {
    ...
    public void createEntity(CutsceneEntity entity) {
        ...
        if (Persistence.cutsceneState != null) {
            ...
            if (renderer != null)
                Persistence.currentmap.cutsceneEntityRenderers.register(entity, renderer);
        }
    }
    ...
    private boolean hasPausingEvent() {
        for (CutsceneEvent e : this.playingEvents)
            if ((e instanceof DelayCutsceneEvent || e instanceof WaitCutsceneEvent) && !e.isOver())
                return true;
        return false;
    }
    ...
    public void removeEntity(CutsceneEntity entity) {
        if (this.entities.contains(entity)) {
            ...
            if (Persistence.cutsceneState != null)
                Persistence.currentmap.cutsceneEntityRenderers.unregister(entity);
        }
    }
    ...
    public void update() {
        ...
        if (this.playingEvents.isEmpty() && this.pendingEvents.isEmpty())
            this.cutscene.onCutsceneEnd();
    }
