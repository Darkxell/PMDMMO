...
public class OptionResultCutsceneEvent extends CutsceneEvent implements CutsceneContext {
    ...
    public void onStart() {
        ...
        if (this.target != null && this.target instanceof OptionDialogCutsceneEvent
                && ((OptionDialogCutsceneEvent) this.target).chosen() == this.option)
    ...
    public String toString() {
        return this.displayID() + "If choice for event (" + this.target + ") is " + this.option + ": Create "
    ...
    public Element toXML() {
        ...
        if (this.target != null)
            root.setAttribute("dialog", String.valueOf(this.target.id));
