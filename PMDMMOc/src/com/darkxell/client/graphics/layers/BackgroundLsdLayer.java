...
public class BackgroundLsdLayer extends BackgroundLayer
{
	...
	public void update()
	{
		...
		counter_1 += 0.3;
		if (counter_1 >= Res_GraphicalLayers.LSD.top(0).getWidth()) counter_1 = 0;
		counter_2 += 0.2;
		if (counter_2 >= Res_GraphicalLayers.LSD.top(0).getWidth()) counter_2 = 0;
		counter_3 += 0.25;
		if (counter_3 >= Res_GraphicalLayers.LSD.top(0).getWidth()) counter_3 = 0;
		counter_4 += 0.35;
		if (counter_4 >= Res_GraphicalLayers.LSD.top(0).getWidth()) counter_4 = 0;
		counter_5 += 0.40;
		if (counter_5 >= Res_GraphicalLayers.LSD.top(0).getWidth()) counter_5 = 0;
		counter_6 += 0.1;
		if (counter_6 >= Res_GraphicalLayers.LSD.top(0).getWidth()) counter_6 = 0;
		counter_7 += 0.07;
		if (counter_7 >= Res_GraphicalLayers.LSD.top(0).getWidth()) counter_7 = 0;
	...
	public void render(Graphics2D g, int width, int height)
	{
		...
		BufferedImage img_bot = new BufferedImage(Res_GraphicalLayers.LSD.bottom(0).getWidth(), Res_GraphicalLayers.LSD.bottom(0).getHeight(),
				BufferedImage.TYPE_4BYTE_ABGR);
		img_bot.createGraphics().drawImage(Res_GraphicalLayers.LSD.bottom(offcolorcounter), rop, 0, 0);
		BufferedImage img_top = new BufferedImage(Res_GraphicalLayers.LSD.top(0).getWidth(), Res_GraphicalLayers.LSD.top(0).getHeight(),
				BufferedImage.TYPE_4BYTE_ABGR);
	...
	{
		for (int i = (int) (direction ? -counter : counter) - Res_GraphicalLayers.LSD.top(0).getWidth(); i <= width; i += Res_GraphicalLayers.LSD.top(0)
				.getWidth())
			g.drawImage(top, i, offset, null);

		for (int i = (int) (direction ? -counter : counter) - Res_GraphicalLayers.LSD.bottom(0).getWidth(); i <= width; i += Res_GraphicalLayers.LSD
				.bottom(0).getWidth())
