...
import com.darkxell.client.mechanics.freezone.entity.AllyEntity;
    ...
    public void update() {
        ...
        if (this.isMain())
            for (int i = 0; i < Persistence.currentmap.triggerzones.size(); i++)
                if (Persistence.currentmap.triggerzones.get(i).getHitbox().intersects(Persistence.currentplayer
