...
public class DungeonLogger
{
	...
	private void reloadMessages(int width, int height)
	{
		...
		for (Message m : this.messages)
			if (m != null) toReturn.addAll(TextRenderer.instance.splitLines(m.toString(), w - 40));
	...
	public void showMessage(Message message)
	{
		...
		this.lastWidth = -1;
		if (!this.parent.isMain()) this.hideMessages();
	}
	...
	public void update()
	{
		...
		if (this.messageOffset > -(this.displayedMessages() - 3) * MESSAGE_HEIGHT) --this.messageOffset;
	}
