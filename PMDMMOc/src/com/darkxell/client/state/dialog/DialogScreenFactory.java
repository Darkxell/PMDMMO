...
public class DialogScreenFactory {
    ...
    private static PortraitEmotion getEmotion(Element el) {
        return PortraitEmotion.valueOf(XMLUtils.getAttribute(el, "emotion", PortraitEmotion.Normal.name()));
    }
    ...
    private static DialogPortraitLocation getPortraitLocation(Element el) {
        return DialogPortraitLocation
                .valueOf(XMLUtils.getAttribute(el, "portrait", DialogPortraitLocation.BOTTOM_RIGHT.name()));
    }
    ...
    private static DialogScreen createPortraitScreen(String type, Element el) {
        ...
        switch (type) {
        case "portrait":
            return new PokemonDialogScreen(species, message, getEmotion(el), getShiny(el), getSpeakerName(species, el),
                    portrait);
        case "player":
