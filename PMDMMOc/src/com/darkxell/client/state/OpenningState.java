...
public class OpenningState extends AbstractState
{
	...
	{
		if (key == Keys.KEY_ATTACK) Persistance.stateManager.setState(new FreezoneExploreState());
	}
	...
	public void render(Graphics2D g, int width, int height)
	{
		...
		g.drawImage(Hud.gametitle, width / 2 - Hud.gametitle.getWidth() / 2, height / 2 - Hud.gametitle.getHeight() / 2, null);
		if (textblink >= 50)
		{
