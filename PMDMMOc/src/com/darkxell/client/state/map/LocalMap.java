...
public class LocalMap extends AbstractDisplayMap {
	...
	public void render(Graphics2D g, int width, int height) {
		...
		g2.drawImage(MapResources.LOCALMAP.image(), offsetx, offsety, null);
		for (LocalMapLocation loc : LocalMapLocation.values())
			g2.drawImage(currentlocation == loc ? MapResources.PIN_RED.image() : MapResources.PIN_YELLOW.image(), offsetx + loc.x,
					offsety + loc.y, null);
