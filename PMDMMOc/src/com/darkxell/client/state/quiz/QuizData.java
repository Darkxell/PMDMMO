...
public class QuizData
{
	...
	public QuizData()
	{
		...
		List<Element> starters = xml.getChild("starters", xml.getNamespace()).getChildren("starter", xml.getNamespace());
	...
	{
		if (this.askedQuestions == null) return null;
	...
	public void chooseQuestions(int questionCount)
	{
		...
		{
			Logger.e("Question count (" + questionCount + ") > question group count (" + this.questionGroups.length + ")! Defaults back to group count.");
