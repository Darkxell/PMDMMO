...
public class MenuWindow {
    ...
    public MenuWindow(Rectangle dimensions) {
        ...
        this.inside = new Rectangle(this.dimensions.x + corner.width, this.dimensions.y + corner.height,
                this.dimensions.width - corner.width * 2, this.dimensions.height - corner.height * 2);
    }
    ...
    public void render(Graphics2D g, Message name, int width, int height) {
        ...
        Rectangle nameInside = new Rectangle(inside.x + cornerName.width, this.dimensions.y - font,
                (hasName ? TextRenderer.width(name) : 10) + 8, font);
        ...
        if (hasName)
            g.fillRect(inside.x, this.dimensions.y + 6, inside.width, 2);
