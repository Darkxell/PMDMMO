...
public class IntegerSelectionState extends AbstractState {
    ...
    public IntegerSelectionState(AbstractGraphicsLayer background, DialogState parent,
            IntegerSelectionListener listener, long min, long max, long start) {
    ...
    public void render(Graphics2D g, int width, int height) {
        ...
        if (this.window == null) {
            ...
            int w = TextRenderer.width(longest) + MenuWindow.MARGIN_X * 2, h = TextRenderer.height()
                    + MenuWindow.MARGIN_Y * 3 + Sprites.Res_Hud.menuHud.nextWindowArrow().getHeight();
        ...
        int arrowx = this.textx + this.currentLogLocation - Sprites.Res_Hud.menuHud.nextWindowArrow().getWidth();
        int uparrowy = texty - MenuWindow.MARGIN_Y / 3;
        int downarrowy = texty + TextRenderer.height() + MenuWindow.MARGIN_Y / 3;
        g.drawImage(Sprites.Res_Hud.menuHud.nextWindowArrow(), arrowx, uparrowy,
                Sprites.Res_Hud.menuHud.nextWindowArrow().getWidth(),
                -Sprites.Res_Hud.menuHud.nextWindowArrow().getHeight(), null);
        g.drawImage(Sprites.Res_Hud.menuHud.nextWindowArrow(), arrowx, downarrowy, null);
    }
