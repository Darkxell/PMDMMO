...
public class FriendAreaInfoState extends InfoState {
    ...
    public FriendAreaInfoState(AbstractState parent, AbstractGraphiclayer background, FriendArea area) {
        ...
        ArrayList<PokemonSpecies> known = Persistence.player.getKnownPokemon();
