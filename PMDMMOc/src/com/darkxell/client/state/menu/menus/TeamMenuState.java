...
public class TeamMenuState extends OptionSelectionMenuState implements ItemActionMessageHandler
{
	...
	public static InfoState createSummaryState(AbstractState background, AbstractState parent, DungeonPokemon dungeon, Pokemon pokemon)
	{
	...
	public static InfoState createSummaryState(AbstractState background, AbstractState parent, Pokemon pokemon)
	{
	...
	protected void onOptionSelected(MenuOption option)
	{
		...
		if (this.listener == null) Persistance.stateManager.setState(createSummaryState(this.backgroundState, this, dp, p));
