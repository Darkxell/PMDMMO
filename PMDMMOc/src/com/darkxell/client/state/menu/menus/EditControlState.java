...
public class EditControlState extends AbstractState {
    ...
    public EditControlState(AbstractGraphicsLayer background, ControlsMenuState parent, ControlMenuOption option) {
        ...
        this.window = new MenuWindow(new Rectangle(16, 32, PrincipalMainState.displayWidth - 16 * 2,
                PrincipalMainState.displayHeight - 32 * 3 / 2));
        Rectangle r = this.window.inside();
        this.progressBar = new Rectangle(r.x + r.width / 8, r.y + r.height / 2 + TextRenderer.height() + 5,
                r.width * 3 / 4, 15);
    }
    ...
    public void render(Graphics2D g, int width, int height) {
        ...
        int secondsLeft = (TICKMAX - this.tick) / GameLoop.TARGET_UPS;
