...
public class ControlsMenuState extends OptionSelectionMenuState implements DialogEndListener {
    ...
    private static final Key[][] tabStructure = {
            { Key.UP, Key.DOWN, Key.LEFT, Key.RIGHT, Key.RUN, Key.DIAGONAL, Key.ROTATE },
    ...
    public ControlsMenuState(AbstractMenuState parent, AbstractGraphicsLayer background) {
        super(background);
        this.parent = parent;
    ...
    protected void onExit() {
        OptionDialogScreen confirm = new OptionDialogScreen(new Message("key.save"), new Message("ui.yes"),
