...
public abstract class AbstractMenuState extends AbstractState {
	...
	/*
	 * protected Rectangle mainWindowDimensions() { int width = 0, height = 0;
	 * for (MenuTab tab : this.tabs) { width = Math.max(width, tab.width());
	 * height = Math.max(height, tab.height()); } width +=
	 * OptionSelectionWindow.MARGIN_X * 2; height +=
	 * OptionSelectionWindow.MARGIN_Y * 2;
	 * 
	 * return new Rectangle(16, 32, width, height); }
	 */
