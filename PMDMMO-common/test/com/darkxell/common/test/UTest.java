...
/**
 * Abstract class that represents a unitary test. For each unitary test you want to create, extend this class and
 * implement a new test method.
 */
public abstract class UTest {
     ...
     * This is the default UTest behavior. It will terminate the process with an error message and the error code -1 if
     * the test fails.
     */
    public static final byte ACTION_BREAK = 0;
    /**
     * Action taken if this test fails.<br/>
     * This action will only output an error message on test failure but will not terminate the process.
     */
    public static final byte ACTION_WARN = 1;
    /**
     * Action taken if this test fails.<br/>
     * This action will only notify the user that the test went wrong but will not output an error message. This value
     * should only be used for legacy tests.
     */
    ...
    /**
     * Tests a feature. This method should be overridden for each unitary test created.<br/>
     * <br/>
    ...
    /**
     * Used by a test to log messages using the appropriate warning level to the console.
     */
