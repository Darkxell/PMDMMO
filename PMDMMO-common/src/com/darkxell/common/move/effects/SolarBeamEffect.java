    ...
    protected void mainEffects(MoveUseEvent moveEvent, MoveEffectCalculator calculator, boolean missed,
        ...
        if (missed) super.mainEffects(moveEvent, calculator, missed, effects);
            ...
            effects.createEffect(e, moveEvent, missed, false, null);
                ...
                new StatusConditionCreatedEvent(moveEvent.floor, eventSource,
                        StatusConditions.Solar_beam.create(moveEvent.floor, moveEvent.target, moveEvent.usedMove.user,
                                moveEvent.floor.random)),
