...
import com.darkxell.common.move.effects.BlowbackEffect;
...
import com.darkxell.common.move.effects.ConditionalEffect;
...
import com.darkxell.common.move.effects.SetPPtoZeroEffect;
...
import com.darkxell.common.move.effects.UserPercentDamageEffect;
...
import com.darkxell.common.move.effects.WrapStatusConditionEffect;
...
public final class MoveEffects {
    ...
    public static final MoveEffect Ifghost_504_505 = new ConditionalEffect(127, -504, -505,
            (moveEvent, events) -> moveEvent.user.species().isType(PokemonType.Ghost));
