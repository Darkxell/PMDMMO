...
public class MoveEffect implements AffectsPokemon {
	...
	/**
	 * This method creates the additional effects (if any) of this Move. Effects
	 * should be added to the input MoveEvents list.
	 *
	...
	/**
	 * @return <code>true</code> if a Move with this Effect has an effect when it
	 *         has no targets.
	 */
	...
	/**
	 * Creates a custom MoveEffectCalculator object. If the effect doesn't need a
	 * custom one, should return null by default.
	 *
	...
	/**
	 * This method creates the main effects of this Move. This method shouldn't be
	 * overridden unless you want to change the basics of how Moves work. Effects
	 * should be added to the input MoveEvents list.
	 *
	 * @param moveEvent  - The Move Use context.
	 * @param calculator - Object that helps with Damage computation.
