...
public class MoveNew
{
	...
	public MoveNew(int id, PokemonType type, int behaviorID, MoveCategory category, int pp, int power, int accuracy, MoveRange range, MoveTarget targets,
			int critical, boolean makesContact, boolean reflectable, boolean snatchable, boolean sound, boolean piercesFreeze, boolean tauntable,
			boolean ginsengable, MoveEffect effect)
	{
		this.id = id;
		this.type = type;
