...
public class DBPlayer implements Communicable {
    ...
    public DBPlayer(long id,
                    ...
                    long moneyinbag,
                    int storyposition,
                    ArrayList<DatabaseIdentifier> pokemonsinzones,
                    ArrayList<DatabaseIdentifier> pokemonsinparty,
                    DatabaseIdentifier mainpokemon,
                    DatabaseIdentifier toolboxinventory,
                    DatabaseIdentifier storageinventory,
                    ArrayList<String> missionsids,
                    int points,
                    boolean isop,
                    boolean isbanned) {
        this.id = id;
