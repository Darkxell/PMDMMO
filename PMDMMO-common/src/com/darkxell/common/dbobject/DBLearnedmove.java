...
public class DBLearnedmove implements Communicable
{
	...
	{
		if (!(obj instanceof DBLearnedmove)) return false;
		DBLearnedmove o = (DBLearnedmove) obj;
		return this.id == o.id && this.slot == o.slot && this.moveid == o.moveid && this.ppmax == o.ppmax && this.isenabled == o.isenabled
				&& this.islinked == o.islinked && this.addedlevel == o.addedlevel;
	}
