...
public class DBPokemon implements Communicable {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.iq != o.iq)
            return false;
        if (this.isshiny != o.isshiny)
            return false;
        if (this.stat_atk != o.stat_atk)
            return false;
        if (this.stat_def != o.stat_def)
            return false;
        if (this.stat_speatk != o.stat_speatk)
            return false;
        if (this.stat_spedef != o.stat_spedef)
            return false;
        if (this.stat_hp != o.stat_hp)
            return false;
        if ((this.holdeditem == null) != (o.holdeditem == null)
                || (this.holdeditem != null && !this.holdeditem.equals(o.holdeditem)))
            return false;
        if (!this.learnedmoves.equals(o.learnedmoves))
            return false;
        return true;
    }
    ...
    public void read(JsonObject value) {
        ...
        if (moves != null && moves.isArray())
            for (JsonValue id : moves.asArray())
                if (id.isNumber())
                    this.learnedmoves.add(new DatabaseIdentifier(id.asLong()));
    }
    ...
    public JsonObject toJson() {
        ...
        if (this.holdeditem != null)
            root.add("holdeditem", this.holdeditem.id);
