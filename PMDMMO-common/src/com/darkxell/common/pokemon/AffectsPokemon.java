 ...
 * Some objects that implement this interface do not <i>belong</i> to a Pokemon (such as Weather), or the object it
 * belongs to is self-evident (such as Move); in that case, <code>isUser</code> booleans in method arguments should be
 * ignored.<br>
 * <br>
 *
...
public interface AffectsPokemon {
     ...
     */
    public default int applyCriticalRateModifications(int critical, MoveContext context, boolean isUser,
     ...
     */
    public default double applyDamageModifications(double damage, boolean isUser, MoveContext context,
            ArrayList<Event> events) {
        return damage;
    }
     ...
     */
    public default double applyEffectivenessModifications(double effectiveness, MoveContext context, boolean isUser) {
     ...
     * @param  value   - The value of the Stat before this object applies its modifications.
     * @param  context - The Move use context. May be <code>null</code> if this calculation is not part of a move use.
     * @param  isUser  - <code>true</code> if this Object belongs to the Move's user (if it's its ability or an item it
     *                 holds).
     * @param  events  - The current Events being generated.
     * @return         The new value of the Stat with modifications applied by this object.
     */
    public default double applyStatModifications(Stat stat, double value, MoveContext context, boolean isUser,
            ArrayList<Event> events) {
        return value;
    }
     ...
     */
    public default int applyStatStageModifications(Stat stat, int stage, MoveContext context, boolean isUser,
            ArrayList<Event> events) {
        return stage;
    }
     ...
     */
    public default double damageMultiplier(boolean isUser, MoveContext context, ArrayList<Event> events) {
        return 1;
    }
