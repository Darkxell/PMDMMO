...
public abstract class AbilityModifyMoveEffect extends Ability
{
	 ...
	 * @param isAdditional - <code>true</code> if this Effect is an additional Effect (=not the main effect of the Move).
	 * @param amIUser - <code>true</code> if this Ability belongs to the Move's user.
	 * @param directedAt - The Pokemon this Effect is targeting (can be different than the Move's target). May be <code>null</code> if no actual target.
	 * @return The new Effect after modification. May return <code>null<code> to cancel the Effect completely. */
	public abstract DungeonEvent modify(DungeonEvent effect, MoveUse usedMove, DungeonPokemon target, Floor floor, boolean missed, boolean isAdditional,
