...
public class PokemonSpecies implements Registrable<PokemonSpecies> {
    ...
    public final float recruitChance;
    public final RecruitLimitation recruitLimitation;
    ...
    public PokemonSpecies(Element xml) {
        ...
        this.recruitChance = XMLUtils.getAttribute(xml, "recruit", -999);
        this.recruitLimitation = RecruitLimitation.valueOf(XMLUtils.getAttribute(xml, "recruitlimi", "NONE"));
    ...
    public PokemonSpecies(int id, int formID, PokemonType type1, PokemonType type2, int baseXP, ArrayList<BaseStats> baseStats, float height,
            float weight, float recruitChance, RecruitLimitation recruitLimitation, Mobility mobility, ArrayList<Integer> abilities,
            int[] experiencePerLevel, HashMap<Integer, ArrayList<Integer>> learnset, ArrayList<Integer> tms, ArrayList<Evolution> evolutions,
            ArrayList<PokemonSpecies> forms, String friendAreaID) {
        this.id = id;
        this.formID = formID;
        this.type1 = type1;
        this.type2 = type2;
    ...
    private PokemonSpecies createForm(Element xml) {
        ...
        float recruitChance = XMLUtils.getAttribute(xml, "recruit", this.recruitChance);
        RecruitLimitation recruitLimitation = RecruitLimitation.valueOf(XMLUtils.getAttribute(xml, "recruitlimit", "NONE"));
        ...
        return new PokemonSpecies(id, formID, type1, type2, baseXP, baseStats, height, weight, recruitChance, recruitLimitation, mobility, abilities,
    ...
    public Element toXML() {
        ...
        XMLUtils.setAttribute(root, "recruit", this.recruitChance, -999);
        XMLUtils.setAttribute(root, "recruitlimit", this.recruitLimitation.toString(), RecruitLimitation.NONE.toString());
    ...
    private void toXML(Element root, PokemonSpecies form) {
        ...
        if (this.recruitChance != form.recruitChance) e.setAttribute("recruit", Float.toString(form.recruitChance));
        if (this.recruitLimitation != form.recruitLimitation) e.setAttribute("recruitlimit", form.recruitLimitation.toString());
