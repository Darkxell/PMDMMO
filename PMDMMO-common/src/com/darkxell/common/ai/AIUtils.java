...
public final class AIUtils {
	...
	/**
	 * @return The direction to face to look at an adjacent enemy. May be null if
	...
	/**
	 * @return The direction to go to for the input Pokemon to reach the target. May
	...
	/**
	 * @return The direction to go to for the input Pokemon to reach the
	 *         destination. May return null if there is no path.
	 */
	...
	/**
	 * @return The farthest Tiles that can be seen and walked on by the input
	 *         Pokemon, sorted by closeness from the Pokemon's facing direction.
	 *         This method considers the Pokemon is not in a Room.
	 */
	...
	/**
	 * @return The general cardinal direction the input Pokemon has to face to look
	 *         at the target.
	 */
	...
	/**
	 * @return The general direction the input Pokemon has to face to look at the
	 *         target.
	 */
	...
	public static Direction generalDirection(Tile origin, Tile destination) {
		/*
		 * if (pokemon == null) System.out.println("pokemon"); if (target == null)
		 * System.out.println("target"); if (pokemon.tile() == null)
		 * System.out.println(pokemon); if (target.tile == null)
	...
	/**
	 * @return True if the input Pokemon is just one tile away from the target. If
	 *         they're diagonally disposed, also checks if there is a wall blocking
	 *         their interaction.
	 */
	...
	/**
	 * @param checkBlockingWalls - If true and the Pokemon are diagonally disposed,
	 *                           also checks if there is a wall blocking their
	 *                           interaction.
	 * @return <code>true</code> if the input Pokemon is one tile away from the
	 *         target.
	 */
	 ...
	 * @return <code>true</code> if the input Pokemon is able to reach the input
	 *         Tile.
	 */
