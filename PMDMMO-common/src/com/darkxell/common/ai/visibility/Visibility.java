...
public class Visibility {
	...
	public boolean isVisible(DungeonPokemon target) {
		...
		if (this.ai.pokemon.tile().isInRoom()) {
			...
			return this.ai.pokemon.tile().room().outline().contains(target.tile());
		}
	...
	/**
	 * @return The list of enemy Pokemon this Pokemon can see, sorted by distance to
	 *         the Pokemon.
	 */
