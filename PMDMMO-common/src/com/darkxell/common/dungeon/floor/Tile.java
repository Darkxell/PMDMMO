...
public class Tile implements ItemContainer, Comparable<Tile> {
	...
	/**
	 * @return The Tile adjacent to this Tile in the input direction. See
	 *         {@link DirectionSet#NORTH}.
	 */
	...
	/**
	 * @return True if the input Pokemon can walk diagonally with this Tile as a
	 *         corner.
	 */
	...
	/**
	 * @return The sum of NORTH, EAST, SOUTH, WEST if the tile in that direction is
	 *         the same type as this tile.
	 */
	...
	/**
	 * @return The sum of each direction if the tile in that direction is the same
	 *         type as this tile.
	 */
	...
	/**
	 * Called when this Tile's type is changed. Reloads the connections of itself
	 * and its neighbors.
	 */
	...
	/**
	 * Sets the Pokemon on this tile. Also changes this Pokemon's previous tile's
	 * Pokemon to null.
	 */
