...
public class DungeonPokemon
{
	...
	/** The Pokémon ID. */
	public final int id;
	/** True if this Pokémon can be recruited. If so, {@link DungeonPokemon#recruitRate} is its recruit rate. */
	...
	public DungeonPokemon(Element xml)
	{
	...
	public DungeonPokemon(int id, int level, FloorSet floors, boolean isRecruitable, float recruitRate)
	{
		this.id = id;
		this.level = level;
		this.floors = floors;
