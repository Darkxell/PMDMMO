...
public abstract class Event implements EventSource {
    ...
    public static class MessageEvent extends Event {
        ...
        public MessageEvent(Floor floor, EventSource eventSource, Message message) {
            this(floor, eventSource, message, null);
        }

        public MessageEvent(Floor floor, EventSource eventSource, Message message, Player target) {
    ...
    public Event(Floor floor, EventSource eventSource) {
        this(floor, eventSource, null);
    }

    public Event(Floor floor, EventSource eventSource, DungeonPokemon actor) {
        this.floor = floor;
