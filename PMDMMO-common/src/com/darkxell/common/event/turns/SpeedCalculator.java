...
public class SpeedCalculator
{
	...
	public SpeedCalculator(Floor floor, DungeonPokemon pokemon)
	{
		...
		if (this.pokemon.getItem() != null) this.modificator.add(this.pokemon.getItem().item());
	...
	public double compute()
	{
		...
		speed = this.modificator.applyStatModifications(Stat.Speed, speed, null, this.pokemon, this.floor, new ArrayList<>());
		if (speed < 0) speed = .5;
