...
public class PokemonRescuedEvent extends DungeonEvent implements Communicable
{
	...
	public ArrayList<DungeonEvent> processServer()
	{
		...
		this.resultingEvents.add(new MessageEvent(this.floor, new Message("mission.rescued").addReplacement("<pokemon>", this.rescued.getNickname())));
	...
	{
		return Json.object().add("player", this.rescuer.getData().id).add("mission", this.mission.missionData.toString()).add("pokemon", this.rescued.id());
	}
