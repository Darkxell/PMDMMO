...
public final class EventCommunication
{
	 ...
	 * @return The Json value of the input DungeonEvent, with the event Class name. Class name is required to be communicated to load the correct Class when reading. */
	 ...
	 * @return A DungeonEvent loaded from the input Json data. May return null if the Json data is incomplete or flawed. */
