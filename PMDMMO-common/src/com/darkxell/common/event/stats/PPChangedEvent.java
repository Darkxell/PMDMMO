...
public class PPChangedEvent extends DungeonEvent {
	...
	public ArrayList<DungeonEvent> processServer() {
		...
		if (this.moveIndex != CHANGE_ALL_MOVES) mid = this.pp >= 0 ? "moves.pp_restored_one" : "moves.pp_lost_one";
		...
		if (this.moveIndex == CHANGE_ALL_MOVES) for (int m = 0; m < this.pokemon.moveCount(); ++m)
