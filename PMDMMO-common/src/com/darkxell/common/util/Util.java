...
public class Util
{
	...
	{
		Player player = new Player("Offline debug account name", PokemonRegistry.find(252).generate(new Random(), 10, 1));
		...
		player.getTeamLeader().setMove(3, new LearnedMove(955));
		// player.getTeamLeader().getData().abilityid = 56;
