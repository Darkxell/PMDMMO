...
public class Util
{
	...
	{
		Player player = new Player("Offline debug account name", PokemonRegistry.find(133).generate(new Random(), 10, 1));
		...
		player.getTeamLeader().setMove(3, new LearnedMove(64));
