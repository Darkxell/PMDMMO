 ...
 * class in their imports if they do not alter the serialization behavior of the superclass. Because of the highly
 ...
 *
 * <p>After initialization, this class should be treated as immutable for the most convenience in implementation.
 * This should be used mostly as a wrapper around the Element for the client's behavior and not as a primary storage
 * method.</p>
 */
